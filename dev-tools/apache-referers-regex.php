<?php
    /* Regex Formatting Generator Script for the Apache Ultimate Bad Bot Blocker
...
class Generator
{
    ...
    {
    $file = "/home/travis/build/mitchellkrogza/apache-ultimate-bad-bot-blocker/.dev-tools/referrers-regex-format.txt";
