#!/bin/bash
# Bash Script for Installing the Apache Bad Bot Blocker for Apache 2.4+ only
...
# Please Note:
# ************
# This version will only work on 2.4 and up as it does not require the mod_access_compat module
# to be loaded. This new Apache 2.4 version uses the new Apache Access Control methods.
