...
curl -A "80legs" http://local.dev:80/index.php 2>&1 >> $_curltest1
...
curl -A "masscan" http://local.dev:80/index.php 2>&1 >> $_curltest2
...
curl -I http://local.dev:80/index.php -e http://100dollars-seo.com 2>&1 >> $_curltest3
...
curl -I http://local.dev:80/index.php -e http://zx6.ru 2>&1 >> $_curltest4
...
curl -v -A "GoogleBot" http://local.dev:80/index.php 2>&1 >> $_curltest5
...
curl -v -A "BingBot" http://local.dev:80/index.php 2>&1 >> $_curltest6
