#!/bin/bash
# Bash Script for Auto Updating the Apache Bad Bot Blocker for Apache 2.4+ only.
...
sudo wget https://github.com/mitchellkrogza/apache-ultimate-bad-bot-blocker/raw/master/Apache_2.4/custom.d/globalblacklist.conf -O /etc/apache2/custom.d/globalblacklist.conf
